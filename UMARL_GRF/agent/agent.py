...
class Agents:
    def __init__(self, args):
        ...
        elif args.alg == 'qweight_vb':
            from policy.qweight_vb import qweight_vb
            self.policy = qweight_vb(args)
        else:
    ...
    def choose_action(self, obs, last_action, agent_num, avail_actions, epsilon, maven_z=None):
        ...
        if self.args.alg == 'coma' or self.args.alg == 'central_v' or self.args.alg == 'reinforce' or self.args.alg == 'qweight_ac':
