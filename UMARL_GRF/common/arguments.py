...
def get_qweight_args(args):
    ...
    ##graph convolution
    args.hidden_dim = 64
    args.out_features = 64  ###必须和hidden_dim保持一致
    args.con_num = 3
    args.convo_heads = 3

    ##qmix
    args.qmix_input_shape = args.out_features * args.con_num  ###必须和args.out_features * args.con_num 保持一致
    ####critic
    args.hidden_dim_critic = 64
    args.input_shape_critic = args.out_features * args.con_num  ###必须和args.out_features * args.con_num 保持一致

    ##weighting net
    args.weight_atten_heads = 3
    args.weight_attend_dim = 64
    args.weight_input_size = args.out_features ##必须和args.out_features保持一致

    ####P(h|ai,ID_i)
    args.state_Pro_dim = 64
    args.input_shape_pro_shape = args.out_features * args.con_num #必须和args.out_features * args.con_num 保持一致
    args.noise_dim = 16
    return args
